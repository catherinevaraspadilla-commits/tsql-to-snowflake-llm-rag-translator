...
CORPUS_DIR = Path(r"C:\Users\CatherineVaras\Downloads\tsql-to-snowflake-llm-rag-translator\project\corpus")

# Logs (append, UTF-8)
EMBED_LOG_FILE = r"C:\Users\CatherineVaras\Downloads\tsql-to-snowflake-llm-rag-translator\project\logs\embed.log"
